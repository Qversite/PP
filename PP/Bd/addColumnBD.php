...
('Иван', 'Иванов', 'Иванович', :id),
('Мария', 'Петрова', 'Игоревна', :id),
('Александр', 'Смирнов', 'Александрович', :id),
('Елена', 'Козлова', 'Викторовна', :id),
('Сергей', 'Морозов', 'Сергеевич', :id),
('Ольга', 'Кузнецова', 'Дмитриевна', :id),
('Дмитрий', 'Павлов', 'Андреевич', :id),
('Анна', 'Соколова', 'Павловна', :id),
('Артем', 'Васильев', 'Артемович', :id),
('Наталья', 'Перлова', 'Сергеевна', :id);";
$stmt = $connection->prepare($sql);
